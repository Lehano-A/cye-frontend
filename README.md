...
2. frontend связан с backend, и оба находятся в облаке. У облака имеется право, при необходимости, принудительно отключать виртуальные машины на определённых тарифах, в связи с чем, велика вероятность, что сначала мне нужно запустить виртуальную машину, после чего frontend сможет получать контент.
